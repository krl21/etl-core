...
>>>>>>> development
        ...
        |> String.replace("\u{0430}", "a")
        |> String.replace("\u{0441}", "c")
        |> String.replace("\u{0435}", "e")
        |> String.replace("\u{0451}", "e")
        |> String.replace("\u{043E}", "o")
        |> String.replace("\u{03BF}", "o")
        |> String.replace("\u{0440}", "p")
        |> String.replace("\u{0445}", "x")
        |> String.replace("\u{0410}", "A")
        |> String.replace("\u{0391}", "A")
        |> String.replace("\u{0412}", "B")
        |> String.replace("\u{0421}", "C")
        |> String.replace("\u{0415}", "E")
        |> String.replace("\u{0395}", "E")
        |> String.replace("\u{041D}", "H")
        |> String.replace("\u{041A}", "K")
        |> String.replace("\u{041C}", "M")
        |> String.replace("\u{041E}", "O")
        |> String.replace("\u{039F}", "O")
        |> String.replace("\u{0420}", "P")
        |> String.replace("\u{0422}", "T")
        |> String.replace("\u{0425}", "X")
    end
